...
export class ProjectsService {
  ...
  projects: Project [] = [
    {id: 0, name: "Sample Angular App", pictures: ["../../assets/AngularPic/cap authentification.png"], projectLink: "https://github.com/Khalyyl/FoodApp", summary: "Food Application", description: "Lorem ipsum dolor sit amet", tags: [Tag.ANGULAR,Tag.TYPESCRIPT]},
